...
public class SaisieEtudiantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTitre.setTextColor(0xFF555555);
        ...
        btnAfficher.setBackgroundColor(0xFFBDBDBD);
        btnAfficher.setTextColor(0xFF000000);
        ...
        btnAfficher.setOnClickListener(v -> {
            ...
            if (cne.isEmpty() || prenom.isEmpty() || nom.isEmpty() || email.isEmpty()) {
                showToastCenter("Veuillez remplir tous les champs");
                return;
            }
